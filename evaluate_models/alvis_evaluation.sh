...
#SBATCH -J compare-models             # the jobname (not needed)

# Load modules with vitual env 'venv_thesis'
# Make sure the same python version is used. Python 3.8.6. 
ml purge
ml Python/3.8.6-GCCcore-10.2.0 SciPy-bundle/2020.11-fosscuda-2020b TensorFlow/2.5.0-fosscuda-2020b matplotlib/3.3.3-fosscuda-2020b
